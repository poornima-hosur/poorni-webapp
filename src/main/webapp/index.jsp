...
<div class="middlecontainer">
    <div class="profile">
      ...
      <div class="contact-me">
        <h2>Get In Touch</h2>
        <p class="pp">Thank You for visting my site . </p>
        <p class="pt">For any other details please feel free to contact-me.I have given my Email Id link below. <br> Have a nice day..</p>
        <a class="btn" href="mailto:kajasharif9894@gmail.com">CONTACT ME</a>
      </div>
